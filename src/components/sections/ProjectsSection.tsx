...
export function ProjectsSection() {
  ...
  return (
    <section id="projects" className="px-6 py-32" style={{ background: 'var(--bg)', position: 'relative', overflow: 'hidden' }}>
      {/* Background Grid */}
      <div style={{
              ...
              >
                ...
                <IdeWindow filename={`${project.name.toLowerCase().replace(/ /g, '_')}.info`}>
                  <div className="flex flex-col h-full overflow-y-auto pr-2" style={{ scrollbarWidth: 'thin' }}>
                    ...
                    <h2 className="text-3xl font-bold tracking-tight glow-text" style={{ fontFamily: 'var(--font-sans)', marginBottom: 16 }}>
                      {project.name}
                    </h2>
      ...
      <style>{`
        ...
        @media (max-width: 1024px) {
          ...
          .project-tab.active {
            ...
            box-shadow: 0 -10px 30px rgba(0, 240, 255, 0.03) inset;
          }
        }
      `}</style>
    </section>
